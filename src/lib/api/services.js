  ...
  Specialties: [
    {
      ...
      name: "Rug Cleaning",
      introduction:
        "Full extraction cleaning to lift dirt from carpet fibers. Spot treatment for stubborn stains.",
      price: [599, 799, 999],
    ...
    },
    {
      ...
      name: "Couch Cleaning",
      introduction:
        "Full extraction cleaning to lift dirt from couch fibers. Stain treatment for specific spots.",
      price: [599, 649, 749],
