        ...
        {selectedAddress && (
          <div className="p-6 border-t bg-white">
            <button
              ...
              className="w-full bg-blue-700 text-white py-4 rounded-full text-sm font-extrabold italic hover:bg-blue-800 disabled:opacity-50 disabled:cursor-not-allowed transition-colors transform "
            >
              SAVE AND FINISH
            </button>
          </div>
