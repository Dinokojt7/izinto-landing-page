    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="bg-white rounded-xl w-11/12 max-w-2xl max-h-[90vh] overflow-hidden">
        ...
        <div className="flex justify-between items-center p-6 border-b">
          <h2 className={`text-2xl font-bold italic ${selectedAddress ? 'text-primary' : 'text-primary'}`}>
                ...
                >
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="flex-1">
                      <div className="font-semibold text-primary">{prediction.street}</div>
                      <div className="text-sm text-gray-600">{prediction.town}</div>
                    </div>
                  </div>
                </div>
              ))}
          ...
          {selectedAddress && (
            <div className="mt-6 p-4 border rounded-lg bg-gray-100 h-48 flex items-center justify-center">
              <div className="text-center text-gray-600">
                <svg className="w-12 h-12 mx-auto mb-2 text-cartBlue" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
