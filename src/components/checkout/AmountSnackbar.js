// components/checkout/AmountSnackbar.js
"use client";
import { motion, AnimatePresence } from "framer-motion";

export default function AmountSnackbar({ isOpen, onClose, minimumAmount }) {
        ...
        >
          <div className="bg-black text-white px-4 py-3 rounded-lg shadow-lg flex items-center justify-between gap-3 sm:px-6 sm:py-4">
            <span className="font-medium text-sm sm:text-base truncate flex-1">
              Minimum order amount is R{minimumAmount}. Please add more items to
              your cart.
            </span>
