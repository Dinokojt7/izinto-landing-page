...
export default function HomeBreadcrumbSection() {
  ...
  return (
    <>
      <div className="w-full bg-white/60 border-y border-gray-200 py-4 md:py-5 mt-16">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between sm:justify-end gap-3 sm:gap-4">
              ...
              {savedAddress ? (
                <button
                  ...
                  className="flex items-start justify-between gap-2 text-primary font-semibold hover:text-gray-700 transition-colors min-w-0 w-full sm:w-auto"
                >
                  <span
