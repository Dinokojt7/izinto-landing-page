  ...
  const socialIcons = [
    {
      ...
      url: "https://www.instagram.com/izinto_za/", // Updated
    },
    {
      name: "x",
      svg: (
      ...
      url: "https://x.com/izinto_za", // Updated
    },
    {
      name: "tiktok",
      svg: (
      ...
      url: "https://www.tiktok.com/@izintoza_", // Updated
    },
    {
      name: "youtube",
      svg: (
      ...
      url: "https://www.youtube.com/@izinto_za", // Updated
    },
  ];
    ...
    appStores: [
      {
        ...
        image: "/images/google.png", // Note: different path from main Footer
      },
      {
        name: "App Store",
        href: "https://apps.apple.com/app/izinto",
        image: "/images/apple.png", // Note: different path from main Footer
      },
    ],
  };
    ...
    <footer className={`bg-gray-100 pt-4 pb-8 ${poppins.className}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row gap-8 mt-12">
          ...
          {/* Section 4: APP STORES - Updated with same styling */}
          <div className="flex-1">
