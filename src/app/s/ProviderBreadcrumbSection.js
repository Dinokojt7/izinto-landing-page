...
export default function CategoryBreadcrumbSection({ provider, onBack }) {
      ...
      <div className="w-full bg-white border-y border-gray-200 py-4 md:py-3 mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div className="flex items-center flex-wrap gap-1 xs:gap-2 text-sm xs:text-xs text-gray-600 justify-center md:justify-start">
              <Link
                href="/services"
              ...
              <span>•</span>
              <span className="font-semibold text-black whitespace-nowrap capitalize">
                {provider}
              </span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between sm:justify-end gap-3 sm:gap-4">
              ...
              {savedAddress ? (
                ...
                >
                  <span
                    className="address-truncate text-base sm:text-base text-black font-extrabold italic text-left"
                    title={savedAddress.street}
                  >
                    {savedAddress.street}
                  </span>
                  <svg
